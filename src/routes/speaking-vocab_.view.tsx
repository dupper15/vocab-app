...
function SpeakingVocabView() {
  ...
  const getCurrentTopics = (part: Part): VocabTopic[] => {
    switch (part) {
      case 1:
        return part1Topics
      case 2:
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const currentTopics = getCurrentTopics(selectedPart)
      const updatedTopics = [...currentTopics, newTopic]

      const fileContent = `import type { VocabTopic } from '../vocabulary'

export const part${selectedPart}Topics: VocabTopic[] = ${JSON.stringify(updatedTopics, null, 2)}
`

      // Hiển thị code để user copy và paste vào file
      console.log('Copy this code to part' + selectedPart + '.ts:')
      console.log(fileContent)

      // Hiển thị trong textarea để dễ copy
      ...
      closeBtn.textContent =
        'Close (Copy và paste vào file part' + selectedPart + '.ts)'
        ...
        {showSuccess && (
          <div className="mb-6 bg-green-50 border-2 border-green-400 text-green-800 px-6 py-4 rounded-xl shadow-lg flex items-center animate-pulse">
            ...
            <span className="font-semibold">
              Topic generated! Copy the code and paste it into the part file.
            </span>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">
                Add vocabulary to speaking parts
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Family, Food & Cooking"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 font-mono text-sm"
                  rows={12}
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold px-6 py-4 rounded-lg text-lg transition-colors shadow-lg hover:shadow-xl"
              >
                Generate Code
              </button>
            </form>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-3 max-h-[600px] overflow-y-auto">
              {getCurrentTopics(selectedPart).map((topic) => (
                <div
                  key={topic.id}
                  className="p-5 border-2 border-gray-200 rounded-xl hover:border-purple-400 hover:shadow-md transition-all duration-200 bg-gradient-to-br from-white to-purple-50"
                >
